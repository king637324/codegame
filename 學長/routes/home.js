                ...
                new Promise((resolve, reject) => {
                    User.getAllUser(function (err, userState){
                        ...
                        for(let i = 0; i < RQ.length; i++){
                            if(i==2){   //取 75%  為 Q3
                                var position = Rhavedata.length*0.25;
                                if ((position % 1) == 0) {
                            ...
                            if(i==1){   //取 50%  為 Q2
                                var position = Rhavedata.length*0.5;
                                if ((position % 1) == 0) {
                                    RQ[i] = (Rhavedata[Math.floor(position)] + Rhavedata[Math.floor(position)+1])/2;
                                }else{
                                    RQ[i] = Rhavedata[Math.floor(position)]; //整數無條件進位
                            ...
                            if(i==0){   //取 25%  為 Q1
                                var position = Rhavedata.length*0.75;
                                if ((position % 1) == 0) {
                                    RQ[i] = (Rhavedata[Math.floor(position)] + Rhavedata[Math.floor(position)+1])/2;
                                }else{
                                    RQ[i] = Rhavedata[Math.floor(position)]; //整數無條件進位
                        ...
                        for(let index = 0; index < UserRFMP.length; index++){
                            if(UserRFMP[index][1] >= RQ[2]){  // 大於等於RQ3，得4分
                                UserRFMP[index][5] = 4;
                                Rscore.push(4);
                        ...
                        for(let i = 0; i < FQ.length; i++){
                            if(i==2){   //取 75%  為 Q3
                                var position = Fhavedata.length*0.25;
                                if ((position % 1) == 0) {
                            ...
                            if(i==1){   //取 50%  為 Q2
                                var position = Fhavedata.length*0.5;
                                if ((position % 1) == 0) {
                                    FQ[i] = (Fhavedata[Math.floor(position)] + Fhavedata[Math.floor(position)+1])/2;
                                }else{
                                    FQ[i] = Fhavedata[Math.floor(position)]; //整數無條件進位
                            ...
                            if(i==0){   //取 25%  為 Q1
                                var position = Fhavedata.length*0.75;
                                if ((position % 1) == 0) {
                                    FQ[i] = (Fhavedata[Math.floor(position)] + Fhavedata[Math.floor(position)+1])/2;
                                }else{
                                    FQ[i] = Fhavedata[Math.floor(position)]; //整數無條件進位
                        ...
                        // 玩家F評分計算
                        for(let index = 0; index < UserRFMP.length; index++){
                            if(UserRFMP[index][2] >= FQ[2]){  // 大於等於FQ3，得4分
                                UserRFMP[index][6] = 4;
                                Fscore.push(4);
                        ...
                        UserSpendTime.getAllUserSpendTimeState(function (err, userSpendTimeState){
                            ...
                            for(let i = 0; i < MQ.length; i++){
                                if(i==2){   //取 75%  為 Q3
                                    var position = Mhavedata.length*0.25;
                                    if ((position % 1) == 0) {
                                ...
                                if(i==1){   //取 50%  為 Q2
                                    var position = Mhavedata.length*0.5;
                                    if ((position % 1) == 0) {
                                        MQ[i] = (Mhavedata[Math.floor(position)] + Mhavedata[Math.floor(position)+1])/2;
                                    }else{
                                        MQ[i] = Mhavedata[Math.floor(position)]; //整數無條件進位
                                ...
                                if(i==0){   //取 25%  為 Q1
                                    var position = Mhavedata.length*0.75;
                                    if ((position % 1) == 0) {
                                        MQ[i] = (Mhavedata[Math.floor(position)] + Mhavedata[Math.floor(position)+1])/2;
                                    }else{
                                        MQ[i] = Mhavedata[Math.floor(position)]; //整數無條件進位
                            ...
                            // 玩家M評分計算
                            for(let index = 0; index < UserRFMP.length; index++){
                                if(UserRFMP[index][3] >= MQ[2]){  // 大於等於MQ3，得4分
                                    UserRFMP[index][7] = 4;
                                    Mscore.push(4);
                            ...
                            for(let i = 0; i < PQ.length; i++){
                                if(i==2){   //取 75%  為 Q3
                                    var position = Phavedata.length*0.25;
                                    if ((position % 1) == 0) {
                                ...
                                if(i==1){   //取 50%  為 Q2
                                    var position = Phavedata.length*0.5;
                                    if ((position % 1) == 0) {
                                        PQ[i] = (Phavedata[Math.floor(position)] + Phavedata[Math.floor(position)+1])/2;
                                    }else{
                                        PQ[i] = Phavedata[Math.floor(position)]; //整數無條件進位
                                ...
                                if(i==0){   //取 25%  為 Q1
                                    var position = Phavedata.length*0.75;
                                    if ((position % 1) == 0) {
                                        PQ[i] = (Phavedata[Math.floor(position)] + Phavedata[Math.floor(position)+1])/2;
                                    }else{
                                        PQ[i] = Phavedata[Math.floor(position)]; //整數無條件進位
                            ...
                            // 玩家P評分計算
                            for(let index = 0; index < UserRFMP.length; index++){
                                if(UserRFMP[index][4] >= PQ[2]){  // 大於等於PQ3，得4分
                                    UserRFMP[index][8] = 4;
                                    Pscore.push(4);
                            ...
                            for(let i=0;i < UserRFMP.length; i++){
                                ...
                                /* RFM
                               if(UserRFMP[i][9] == 0 && UserRFMP[i][10] == 0 && UserRFMP[i][11] == 0){    UserRFMP[i][13] = "000型";   }
                               else if(UserRFMP[i][9] == 0 && UserRFMP[i][10] == 0 && UserRFMP[i][11] == 1){    UserRFMP[i][13] = "001型";   }
                               else if(UserRFMP[i][9] == 0 && UserRFMP[i][10] == 1 && UserRFMP[i][11] == 0){    UserRFMP[i][13] = "010型";   }
                               else if(UserRFMP[i][9] == 0 && UserRFMP[i][10] == 1 && UserRFMP[i][11] == 1){    UserRFMP[i][13] = "011型";   }
                               else if(UserRFMP[i][9] == 1 && UserRFMP[i][10] == 0 && UserRFMP[i][11] == 0){    UserRFMP[i][13] = "100型";   }
                               else if(UserRFMP[i][9] == 1 && UserRFMP[i][10] == 0 && UserRFMP[i][11] == 1){    UserRFMP[i][13] = "101型";   }
                               else if(UserRFMP[i][9] == 1 && UserRFMP[i][10] == 1 && UserRFMP[i][11] == 0){    UserRFMP[i][13] = "110型";   }
                               else if(UserRFMP[i][9] == 1 && UserRFMP[i][10] == 1 && UserRFMP[i][11] == 1){    UserRFMP[i][13] = "111型";   }
                               else if(UserRFMP[i][9] == -1 && UserRFMP[i][10] == -1 && UserRFMP[i][11] == -1){    UserRFMP[i][13] = "NaN";   }
                               */
                                /* FMP
                               if(UserRFMP[i][10] == 0 && UserRFMP[i][11] == 0 && UserRFMP[i][12] == 0){    UserRFMP[i][13] = "000型";   }
